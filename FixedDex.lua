...
Main = (function()
	...
	Main.FetchAPI = function()
		...
		if Main.Elevated then
			...
			-- 	end
			-- end
            rawAPI = Lib.ReadFile("ditconme.json") or game:HttpGet("https://raw.githubusercontent.com/Kiet1308/CTE-PUBLIC/main/dexcmm.json")
            if not Lib.ReadFile("ditconme.json") then 
                writefile("ditconme.json",rawAPI)
            end
			--rawAPI = rawAPI or game:HttpGet("https://raw.githubusercontent.com/Kiet1308/CTE-PUBLIC/main/dexcmm.json")
		else
